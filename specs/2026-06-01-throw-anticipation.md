...
Implementation: Manual (this session)
Notes: Shipped in full — universal fly-in across normal/shop/tutorial throws, single `throw_anticipation_enabled` flag, seamless color-matched hand-off. Deferred: end-of-tween scale overshoot (squash pop) and a motion-trail/streak; both additive, neither touches the impact flow.
---
