...
Implementation: Pending — archived when work moved on to the 2026-05-28 bug-fix pass before this was implemented. Pick up from this spec when revisiting the checkout helper.
Notes: Builds on the shipped checkout helper (`specs/2026-05-22-checkout-helper.md`). No code changes have landed against this spec. Two motivating bugs (401 off-board fallback, 166 mid-zone tiebreak) still reproduce in the current build until this ships.
---
