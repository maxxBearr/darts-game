...
No spec is currently being designed or implemented. The most recent specs —
**Boss Redesign — Reactive Counters + Mutating Variants** (logic pass) and its
**Rendering & Feel Follow-up** — both shipped 2026-06-01 and were archived to
`specs/2026-06-01-boss-redesign-reactive-counters.md` and
`specs/2026-06-01-boss-redesign-rendering-feel-followup.md`.

When the next feature is being designed, replace this section with its spec (see the
