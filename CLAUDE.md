...
No active spec right now — the previous one (`specs/2026-05-25-boss-encounters-and-level-select.md`, the boss + level select + reward system) shipped 2026-05-26 and was archived 2026-05-27.

Replace this section with the next spec when one is being designed or implemented. Use the same shape as the archived spec: a status header, scope, design context, design positions, system descriptions, phases, architectural notes, and open future hooks.
