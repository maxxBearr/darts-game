...
func apply_to_throw_mechanic(throw_mech: Node2D, base_stats: Dictionary) -> void:
	...
	throw_mech.horizontal_speed = base_stats["horizontal_speed"] + bonuses["horizontal_speed"]
	throw_mech.vertical_speed = base_stats["vertical_speed"] + bonuses["vertical_speed"]
