...
- New unlock conditions follow the existing seven subclasses (LegWinHit, LegStat, CareerCount, RunConstraint, ShopAcquisition, SlotsFilled, RelicCount). Adding a new family of conditions = new subclass mirroring the `ThrowModifier` pattern. Don't bolt unrelated semantics onto an existing subclass.
